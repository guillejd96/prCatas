<?php 
	...
	$sqlPersona = "SELECT * FROM persona WHERE idUsuario=".$idPreview;
	$resPersona = mysqli_query($conexion,$sqlPersona)->fetch_row();

	$idPersona = $resPersona[0];
	$nombre = $resPersona[1];

	$sqlUsuario = "SELECT usuario FROM usuario WHERE id=".$idPreview;
	...
	$sqlNAmigos = "SELECT COUNT(*) FROM amigos WHERE aceptada=1 AND idUsuario1 = ".$idPreview;
